      ...
      <div>
        <Link href="/">
          ...
          <div className="flex flex-col gap-4">
            {/* change pass */}
            <div className="bg-linear-to-l from-[#DBEAFE]/20 to-[#DBEAFE] flex items-center gap-3 py-6 px-6 rounded-xl border-[#DBEAFE]">
              <div>
                <Image
                  src={lock}
                  alt="lock"
            ...
            {/* delete */}
            <div className="bg-linear-to-l from-[#FBCFE8]/20 to-[#FBCFE8]/80 flex items-center gap-3 py-6 px-6 rounded-xl border-[#DBEAFE]">
              <div>
                <Image
                  src={cross}
                  alt="lock"
